...
namespace GraphQL.Client.State
{
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("StrawberryShake", "13.0.0.0")]
    public partial class GetUserIdBuilder : global::StrawberryShake.OperationResultBuilder<global::GraphQL.Client.IGetUserIdResult>
    {
        private readonly global::StrawberryShake.IEntityStore _entityStore;
        ...
        protected override global::StrawberryShake.IOperationResultDataFactory<global::GraphQL.Client.IGetUserIdResult> ResultDataFactory { get; }
        ...
        private global::StrawberryShake.EntityId? Update_IGetUserId_UserEntity(global::StrawberryShake.IEntityStoreUpdateSession session, global::System.Text.Json.JsonElement? obj, global::System.Collections.Generic.ISet<global::StrawberryShake.EntityId> entityIds)
        {
            ...
            if (entityId.Name.Equals("User", global::System.StringComparison.Ordinal))
            {
                ...
                {
                    session.SetEntity(entityId, new global::GraphQL.Client.State.UserEntity(Deserialize_NonNullableInt32(global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "id"))));
                }
                else
                {
                    session.SetEntity(entityId, new global::GraphQL.Client.State.UserEntity(Deserialize_NonNullableInt32(global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "id"))));
