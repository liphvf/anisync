...
namespace GraphQL.Anilist
{
    ...
    {
        public GetUserIdResult(global::GraphQL.Anilist.IGetUserId_User? user)
        {
            User = user;
        }
        ...
        /// User query
        /// </summary>
        public global::GraphQL.Anilist.IGetUserId_User? User { get; }
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("StrawberryShake", "13.0.0.0")]
    public partial class GetUserIdQuery : global::GraphQL.Anilist.IGetUserIdQuery
    {
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("StrawberryShake", "13.0.0.0")]
    public partial class GraphQlClient : global::GraphQL.Anilist.IGraphQlClient
    {
        private readonly global::GraphQL.Anilist.IGetUserIdQuery _getUserId;
        public GraphQlClient(global::GraphQL.Anilist.IGetUserIdQuery getUserId)
        {
        ...
        public global::GraphQL.Anilist.IGetUserIdQuery GetUserId => _getUserId;
    }
    ...
    {
        global::GraphQL.Anilist.IGetUserIdQuery GetUserId { get; }
    }
}

namespace GraphQL.Anilist.State
{
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("StrawberryShake", "13.0.0.0")]
    public partial class GetUserIdResultFactory : global::StrawberryShake.IOperationResultDataFactory<global::GraphQL.Anilist.GetUserIdResult>
    {
        private readonly global::StrawberryShake.IEntityStore _entityStore;
        private readonly global::StrawberryShake.IEntityMapper<global::GraphQL.Anilist.State.UserEntity, GetUserId_User_User> _getUserId_User_UserFromUserEntityMapper;
        public GetUserIdResultFactory(global::StrawberryShake.IEntityStore entityStore, global::StrawberryShake.IEntityMapper<global::GraphQL.Anilist.State.UserEntity, GetUserId_User_User> getUserId_User_UserFromUserEntityMapper)
        {
        ...
        global::System.Type global::StrawberryShake.IOperationResultDataFactory.ResultType => typeof(global::GraphQL.Anilist.IGetUserIdResult);
        ...
        private global::GraphQL.Anilist.IGetUserId_User? MapIGetUserId_User(global::StrawberryShake.EntityId? entityId, global::StrawberryShake.IEntityStoreSnapshot snapshot)
        {
            if (entityId is null)
            {
                return null;
            ...
            {
                return _getUserId_User_UserFromUserEntityMapper.Map(snapshot.GetEntity<global::GraphQL.Anilist.State.UserEntity>(entityId.Value) ?? throw new global::StrawberryShake.GraphQLClientException());
            }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("StrawberryShake", "13.0.0.0")]
    public partial class GetUserIdBuilder : global::StrawberryShake.OperationResultBuilder<global::GraphQL.Anilist.IGetUserIdResult>
    {
        private readonly global::StrawberryShake.IEntityStore _entityStore;
        private readonly global::StrawberryShake.IEntityIdSerializer _idSerializer;
        private readonly global::StrawberryShake.Serialization.ILeafValueParser<global::System.Int32, global::System.Int32> _intParser;
        public GetUserIdBuilder(global::StrawberryShake.IEntityStore entityStore, global::StrawberryShake.IEntityIdSerializer idSerializer, global::StrawberryShake.IOperationResultDataFactory<global::GraphQL.Anilist.IGetUserIdResult> resultDataFactory, global::StrawberryShake.Serialization.ISerializerResolver serializerResolver)
        {
            _entityStore = entityStore ?? throw new global::System.ArgumentNullException(nameof(entityStore));
        ...
        protected override global::StrawberryShake.IOperationResultDataFactory<global::GraphQL.Anilist.IGetUserIdResult> ResultDataFactory { get; }
        ...
        protected override global::StrawberryShake.IOperationResultDataInfo BuildData(global::System.Text.Json.JsonElement obj)
        {
            ...
            {
                userId = Update_IGetUserId_UserEntity(session, global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "User"), entityIds);
                snapshot = session.CurrentSnapshot;
            });
            return new GetUserIdResultInfo(userId, entityIds, snapshot.Version);
        }

        private global::StrawberryShake.EntityId? Update_IGetUserId_UserEntity(global::StrawberryShake.IEntityStoreUpdateSession session, global::System.Text.Json.JsonElement? obj, global::System.Collections.Generic.ISet<global::StrawberryShake.EntityId> entityIds)
        {
            if (!obj.HasValue)
            {
                return null;
            ...
            {
                if (session.CurrentSnapshot.TryGetEntity(entityId, out global::GraphQL.Anilist.State.UserEntity? entity))
                {
                    session.SetEntity(entityId, new global::GraphQL.Anilist.State.UserEntity(Deserialize_NonNullableInt32(global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "id"))));
                }
                else
                {
                    session.SetEntity(entityId, new global::GraphQL.Anilist.State.UserEntity(Deserialize_NonNullableInt32(global::StrawberryShake.Json.JsonElementExtensions.GetPropertyOrNull(obj, "id"))));
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("StrawberryShake", "13.0.0.0")]
    public partial class GetUserId_User_UserFromUserEntityMapper : global::StrawberryShake.IEntityMapper<global::GraphQL.Anilist.State.UserEntity, GetUserId_User_User>
    {
        private readonly global::StrawberryShake.IEntityStore _entityStore;
        ...
        public GetUserId_User_User Map(global::GraphQL.Anilist.State.UserEntity entity, global::StrawberryShake.IEntityStoreSnapshot? snapshot = null)
        {
            if (snapshot is null)
            {
                snapshot = _entityStore.CurrentSnapshot;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class GraphQlClientServiceCollectionExtensions
    {
        public static global::StrawberryShake.IClientBuilder<global::GraphQL.Anilist.State.GraphQlClientStoreAccessor> AddGraphQlClient(this global::Microsoft.Extensions.DependencyInjection.IServiceCollection services, global::StrawberryShake.ExecutionStrategy strategy = global::StrawberryShake.ExecutionStrategy.NetworkOnly)
        {
            ...
            return new global::StrawberryShake.ClientBuilder<global::GraphQL.Anilist.State.GraphQlClientStoreAccessor>("GraphQlClient", services, serviceCollection);
        }
        ...
        private static global::Microsoft.Extensions.DependencyInjection.IServiceCollection ConfigureClientDefault(global::System.IServiceProvider parentServices, global::Microsoft.Extensions.DependencyInjection.ServiceCollection services, global::StrawberryShake.ExecutionStrategy strategy = global::StrawberryShake.ExecutionStrategy.NetworkOnly)
        {
            ...
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::StrawberryShake.IEntityMapper<global::GraphQL.Anilist.State.UserEntity, global::GraphQL.Anilist.GetUserId_User_User>, global::GraphQL.Anilist.State.GetUserId_User_UserFromUserEntityMapper>(services);
            ...
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::StrawberryShake.IOperationResultDataFactory<global::GraphQL.Anilist.IGetUserIdResult>, global::GraphQL.Anilist.State.GetUserIdResultFactory>(services);
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::StrawberryShake.IOperationResultDataFactory>(services, sp => global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<global::StrawberryShake.IOperationResultDataFactory<global::GraphQL.Anilist.IGetUserIdResult>>(sp));
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::StrawberryShake.IOperationRequestFactory>(services, sp => global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<global::GraphQL.Anilist.IGetUserIdQuery>(sp));
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::StrawberryShake.IOperationResultBuilder<global::System.Text.Json.JsonDocument, global::GraphQL.Anilist.IGetUserIdResult>, global::GraphQL.Anilist.State.GetUserIdBuilder>(services);
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::StrawberryShake.IOperationExecutor<global::GraphQL.Anilist.IGetUserIdResult>>(services, sp => new global::StrawberryShake.OperationExecutor<global::System.Text.Json.JsonDocument, global::GraphQL.Anilist.IGetUserIdResult>(global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<global::StrawberryShake.Transport.Http.IHttpConnection>(sp), () => global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<global::StrawberryShake.IOperationResultBuilder<global::System.Text.Json.JsonDocument, global::GraphQL.Anilist.IGetUserIdResult>>(sp), () => global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<global::StrawberryShake.IResultPatcher<global::System.Text.Json.JsonDocument>>(sp), global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<global::StrawberryShake.IOperationStore>(sp), strategy));
            ...
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::GraphQL.Anilist.GetUserIdQuery>(services);
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::GraphQL.Anilist.IGetUserIdQuery>(services, sp => global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<global::GraphQL.Anilist.GetUserIdQuery>(sp));
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::StrawberryShake.IEntityIdSerializer, global::GraphQL.Anilist.State.GraphQlClientEntityIdFactory>(services);
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::GraphQL.Anilist.GraphQlClient>(services);
            global::Microsoft.Extensions.DependencyInjection.ServiceCollectionServiceExtensions.AddSingleton<global::GraphQL.Anilist.IGraphQlClient>(services, sp => global::Microsoft.Extensions.DependencyInjection.ServiceProviderServiceExtensions.GetRequiredService<global::GraphQL.Anilist.GraphQlClient>(sp));
            return services;
        }
